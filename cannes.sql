...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : Jeu . 18 juin. 2012 à 16:04
...
(4, 'PARTY GIRL',95 , 'France',4 ),
(5, 'BIRD PEOPLE',127 , 'France', 5),
(6, 'LOST RIVER',105 , 'Anglais/Canada', 6),
(7, 'AMOUR FOU',96 , 'Allemagne',8 ),
(8, 'CHARLIE\'S COUNTRY',108 , 'Australien', 9),
(9, 'THE SALT OF THE EARTH',100 , 'Allemagne/Bresil',11 ),
(10, 'MAPS TO THE STARS', 111, 'Canada',12 ),
(11, 'DEUX JOURS, UNE NUIT',95 , 'Belgique',13 ),
(12, 'MOMMY', 140 , 'Canada',14 ),
(13, 'CAPTIVES',113 , 'Canada/Bresil',15 ),
(14, 'THE SEARCH', 200, 'France',16 ),
(15, 'THE HOMESMAN',122 , 'Amerique',17 ),
(16, 'Le dictateur', 126, 'Anglais', 7),
(17, 'STILL THE WATER',110 , 'Japo,', 18),
(18, 'MR. TURNER', 149, 'Anglais', 19),
(19, 'Reservoir Dogs', 99, 'Amerique', 1),
(20, 'TIMBUKTU', 100, 'Mauritanie/Allemagne', 20);
-- --------------------------------------------------------
...
(2, 'AMACHOUKELI', 'Marie', 2, 4),
(3, 'BURGER', 'Claire', 2, 4),
(4, 'Halgarth', 'Samuel', 2, 4),
(5, 'FERRAN', 'Pascale', 2, 5),
(6, 'GOSLING', 'Ryan', 2, 6),
(7, 'Monkton', 'Rachelle', 2, 16),
(8, 'HAUSNER', 'Jessica', 2, 7),
(9, 'de HEER', 'Rolf', 2, 8),
(10, 'Vollam', 'Bancroft', 1, 16),
(11, 'WENDERS', 'Wim', 2, 9),
(12, 'CRONENBERG', 'David', 1, 10),
(13, 'DARDENNE', 'Jean-Pierre', 1, 11),
(14, 'DOLAN', 'Xavier', 1, 12),
(15, 'EGOYAN', 'Atom', 1, 13),
(16, 'HAZANAVICIUS', 'Michel', 1, 14),
(17, 'JONES', 'Tommy Lee', 1, 15),
(18, 'KAWASE', 'Naomi', 1, 17),
(19, 'LEIGH', 'Mike', 1, 18),
(20, 'SISSAKO', 'Abderrahmane', 1, 20),
(21, 'RIBEIRO SALGADO','Juliano',2,9),
(22, ' DARDENNE','Luc', 1, 11);
...
(3, 'Au canard foûtu', 1, 1, 'Super Canards,Piscine', '8 avenue du canard');
